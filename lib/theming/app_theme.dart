...
class AppThemeData {
  ...
  static AppThemeData lerp(
    ...
    return AppThemeData(
      ...
      settingsText: Color.lerp(
        a.settingsText,
        b.settingsText,
        t,
      )!,
      settingsLabel: Color.lerp(
        a.settingsLabel,
        b.settingsLabel,
        t,
      )!,
      settingsCta: Color.lerp(
        a.settingsCta,
        b.settingsCta,
        t,
      )!,
      ...
      settingsInactiveIconBackground: Color.lerp(
          ...
          t)!,
      inactiveThemePanelRing: Color.lerp(
        a.inactiveThemePanelRing,
        b.inactiveThemePanelRing,
        t,
      )!,
    );
  }
